...
class PolypTestDataset(Dataset):
    """
    Dataloader for polyp segmentation tasks in testing phase
    """
...
def get_test_loader(image_root, gt_root, batchsize, trainsize, shuffle=False, num_workers=4, pin_memory=True):
    dataset = PolypTestDataset(image_root, gt_root, trainsize)
